...
export const ALUMNI_PLACEMENTS: Brand[] = [
  ...
  // Accenture doubles as an affiliation; same file serves both lists.
  { name: "Accenture",       logo: "/partners/accenture.png", mono: true },
  { name: "PwC",             logo: "/alumni/pwc.svg",      mono: true },
